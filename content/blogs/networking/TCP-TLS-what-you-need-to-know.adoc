---
title: "TCP - TLS What You Need to Know"
...
But honestly, I feel bad about our teammate.
We have lack of knowledge on some kind of fundamentals of networking like TCP, UDP, DHCP, ...
...
----
include::./content/blogs/Assets/plantuml/tcp_handshake.plantuml[]
----
